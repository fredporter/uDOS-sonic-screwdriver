...
- teach how Sonic deploys `uDOS` and `uHOME` onto real hardware
- explain service handoff boundaries between Sonic, `uDOS`, and `uHOME-server`
- connect hardware bootstrap work to larger infrastructure outcomes
...
- provision a deployment profile that hands off correctly to `uDOS` and `uHOME`

Intended outcome:

- the learner understands how Sonic fits into the wider repo family and where its ownership ends
