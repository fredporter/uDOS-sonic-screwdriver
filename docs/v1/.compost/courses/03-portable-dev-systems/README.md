...
- teach portable OS environments and device-rescue patterns
- explain how local drives, payloads, and staging areas fit together
- position Sonic as a portable development and recovery toolkit

Current source material to migrate:

- `docs/06-local-drives.md`
- `docs/howto/standalone-release-and-install.md`

Planned project:

- assemble a portable development or rescue environment using Sonic-managed assets

Intended outcome:

- the learner can describe and stage a portable system that is useful beyond one target machine
